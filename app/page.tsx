      ...
      <div style={{
        ...
        {user && (
          <div style={{ display: "flex", alignItems: "center", gap: "12px", paddingBottom: "20px", borderBottom: "1px solid rgba(255,255,255,0.1)" }}>
            ...
            <div>
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "14px", fontWeight: 600, color: "var(--permanent-parchment)" }}>{user.name}</p>
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "11px", color: "rgba(246,241,234,0.45)" }}>{user.email}</p>
            </div>
          </div>
        )}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
          {[
            { label: "Read experiences", icon: "M12 20h9M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z" },
            { label: "My profile", icon: "M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2M12 11a4 4 0 100-8 4 4 0 000 8z" },
            { label: "Guides", icon: "M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75" },
            { label: "Annie Plus", icon: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" },
          ].map((item) => (
            <div key={item.label} style={{
              ...
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: "14px", fontWeight: 500 }}>{item.label}</span>
            </div>
          ))}
        </div>
        ...
        <div style={{ marginTop: "auto" }}>
          <button
            ...
            style={{
              ...
              color: "rgba(246,241,234,0.6)", width: "100%", marginBottom: "12px",
            }}
          >
            {mounted && theme === "dark" ? (
          ...
          {user ? (
            ...
            <button onClick={handleSignIn} style={{
              width: "100%", background: "var(--permanent-gold)",
        ...
        <div className="desktop-nav" style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          ...
          {user ? (
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              <span onClick={handleSignOut} style={{ fontFamily: "'Inter', sans-serif", fontSize: "11px", color: "rgba(246,241,234,0.35)", cursor: "pointer" }}>
                Sign out
              </span>
            </div>
          ) : (
            <span onClick={handleSignIn} style={{ fontFamily: "'Inter', sans-serif", fontSize: "12px", fontWeight: 500, color: "rgba(246,241,234,0.55)", cursor: "pointer" }}>
              Sign in
            </span>
          )}
